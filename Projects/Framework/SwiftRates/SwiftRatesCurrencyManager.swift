//
//  SwiftRatesCurrencyManager.swift
//  SwiftRates
//
//
...
class SwiftRatesCurrencyManager : NSObject {
	
	// MARK: - Properties
	
	fileprivate let request = SwiftRatesCurrencyRequest()
	fileprivate let parser = SwiftRatesCurrencyParser()
	fileprivate let storage = SwiftRatesCurrencyStorage()
