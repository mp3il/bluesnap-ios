...
class BSShippingViewController: UIViewController, UITextFieldDelegate {
    ...
    func initScreen(paymentRequest : BSCcPaymentRequest!, payText : String!,submitPaymentFields : @escaping () -> Void, countryManager : BSCountryManager!, firstTime: Bool, updateTaxFunc: ((_ shippingCountry : String, _ shippingState : String?, _ priceDetails : BSPriceDetails) -> Void)?) {
